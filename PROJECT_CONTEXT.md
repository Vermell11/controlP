...
Reto actual: cerrar V1.5.3 and continue with V1.5.4 identity, personal memory and vocabulary. All future mutations must reuse the mandatory `propuesta → vista previa → confirmación → ejecución → traza` pipeline. Roadmap in `Proyectos/ControlP/Roadmap`; data architecture in `Proyectos/ControlP/Arquitectura/Datos`.
